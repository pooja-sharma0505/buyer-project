<template>
  <div class="home-page">
    <div class="container">
      ...
      <p v-if="loading" class="status-text">Loading products...</p>
...
/** Same category labels as your `products.category` column; always shown for filters */
...
/** Keep URL ?category= in sync so filters work with links and refresh */
...
/* Desktop: exactly 3 columns per row */
.grid {
  display: grid;
