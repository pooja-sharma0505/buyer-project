  ...
  <div class="wishlist-page">
    <div class="container">
      <div class="top">
        ...
        <h1>Wishlist ({{ wishlist.state.items.length }})</h1>
      </div>

      <p v-if="wishlist.state.items.length === 0" class="empty">Your wishlist is empty. Save items from the home page or product details.</p>

      <ul v-else class="list">
        <li v-for="item in wishlist.state.items" :key="item.id" class="row">
          ...
          <div class="info">
            ...
            <div class="actions">
              <button type="button" class="btn secondary" @click="wishlist.removeFromWishlist(item.id)">Remove</button>
